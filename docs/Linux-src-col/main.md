...
5. 卸载多余内核：[/Linux-solutions/collect#清理多余的系统内核](/Linux-solutions/collect#清理多余的系统内核)
...
> 另见 “[4.1.1.3 软件包管理及应用商店](/Linux-src-col/main#_4-1-1-3-软件包管理及应用商店)”。
...
> 有些命令行应用在“[4.1 应用分享和使用技巧](Linux-src-col/main#_4-1-应用分享和使用技巧)”。
...
> 部分硬件相关的资源在“[2.4.3 性能和电源管理](/Linux-src-col/main#_2-4-3-性能和电源管理)”。
